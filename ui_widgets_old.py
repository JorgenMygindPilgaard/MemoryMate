from PyQt5.QtWidgets import QWidget, QHBoxLayout, QVBoxLayout, QGridLayout, QTreeView, QFileSystemModel, QLabel, QLineEdit, QPlainTextEdit, QDateTimeEdit, QDateEdit, QPushButton, QListWidget, QAbstractItemView, QMenu, QAction, QDialog, QApplication, QCompleter
    ...
    def __prepare_metadata_widgets(self):
        ...
        if self.__file_name != None and self.__file_name != '':
            ...
            for logical_tag in tags:
                self.metadata_layout.addWidget(QLabel(tags[logical_tag][0]),grid_row,0)     # Label in column 0 of layout"
                self.metadata_layout.addWidget(tags[logical_tag][1], grid_row, 1)           # Widget in column 1 of layout"
                grid_row += 1
            grid_row += 1

    ...
    while True:
        if isLightroomRunning() or isCatalogLocked(lrcat_path):
            if silent:
                break
            msg_box = QMessageBox()
            msg_box.setWindowTitle(getText('lr_filename_update_error_title'))
            msg_box.setText(getText('lr_filename_update_error_msg'))
            msg_box.setIcon(QMessageBox.Icon.Warning)
            retry_button = msg_box.addButton(getText("lr_filename_update_retry"), QMessageBox.ButtonRole.AcceptRole)
            cancel_button = msg_box.addButton(getText("lr_filename_update_later"), QMessageBox.ButtonRole.RejectRole)

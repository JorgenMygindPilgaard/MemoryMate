...
class Texts:
    ...
    def _initialize():
        Texts.keys_texts = {
            ...
            "file_preview_incorrect_type": {
                "DA": "Det ser ud til, at filen ikke er et billede. Indholdet tyder på, at det er en <file_type>-fil",
                "EN": "The file does not appear to be an image. Its contents suggest that it is a <file_type> file.",
                "FR": "Le fichier ne semble pas être une image. Son contenu indique qu’il s’agit d’un fichier <file_type>.",
                "ES": "El archivo no parece ser una imagen. Su contenido indica que es un archivo <file_type>.",
                "DE": "Die Datei scheint kein Bild zu sein. Der Inhalt deutet darauf hin, dass es sich um eine <file_type>-Datei handelt.",
                "FI": "Tiedosto ei vaikuta olevan kuva. Sen sisältö viittaa siihen, että kyseessä on <file_type>-tiedosto.",
                "SV": "Filen verkar inte vara en bild. Innehållet tyder på att det är en <file_type>-fil.",
                "IT": "Il file non sembra essere un'immagine. Il contenuto indica che si tratta di un file <file_type>."
            },
            ...
            "tag_label_insert_unit": {
                "DA": "Insert Unit (px, percent)",
                "EN": "Insert Unit (px, percent)",
                "FR": "Insert Unit (px, percent)",
                "ES": "Insert Unit (px, percent)",
                "DE": "Insert Unit (px, percent)",
                "FI": "Insert Unit (px, percent)",
                "SV": "Insert Unit (px, percent)",
                "IT": "Insert Unit (px, percent)",
            },
            "tag_label_insert_origin": {
                "DA": "Insert Origin",
                "EN": "Insert Origin",
                "FR": "Insert Origin",
                "ES": "Insert Origin",
            ...
            "settings_garmin_integration_explanation": {
                "DA": "Hvis du tracker dine vandreture i Garmin Connect, kan du bruge rutedata til automatisk at tilføje geo-lokation til dine billeder. Aktivér blot integrationen, og brug derefter kontekstmenuen i filoversigten til at udfylde eller overskrive manglende lokationer for markerede filer og mapper.",
                "EN": "If you track your hikes in Garmin Connect, you can use the route data to automatically add geo-location to your photos. Simply activate the integration, then use the context menu in the file browser to fill in or overwrite missing locations for selected files and folders.",
                "FR": "Si vous enregistrez vos randonnées dans Garmin Connect, vous pouvez utiliser les données de parcours pour ajouter automatiquement la géolocalisation à vos photos. Activez simplement l’intégration, puis utilisez le menu contextuel dans l’explorateur de fichiers pour compléter ou remplacer les localisations manquantes pour les fichiers et dossiers sélectionnés.",
                "ES": "Si registras tus rutas de senderismo en Garmin Connect, puedes usar los datos del recorrido para añadir automáticamente la geolocalización a tus fotos. Simplemente activa la integración y utiliza el menú contextual en el explorador de archivos para completar o sobrescribir ubicaciones faltantes en los archivos y carpetas seleccionados.",
                "DE": "Wenn du deine Wanderungen in Garmin Connect aufzeichnest, kannst du die Routendaten verwenden, um deinen Fotos automatisch Geo-Informationen hinzuzufügen. Aktiviere einfach die Integration und nutze dann das Kontextmenü im Dateibrowser, um fehlende Ortsangaben für ausgewählte Dateien und Ordner auszufüllen oder zu überschreiben.",
                "FI": "Jos tallennat vaelluksesi Garmin Connectiin, voit käyttää reittitietoja lisätäksesi kuviisi geosijainnin automaattisesti. Aktivoi integraatio ja käytä sitten tiedostoselaimen kontekstivalikkoa puuttuvien sijaintien täyttämiseen tai ylikirjoittamiseen valituissa tiedostoissa ja kansioissa.",
                "SV": "Om du spelar in dina vandringar i Garmin Connect kan du använda ruttdatan för att automatiskt lägga till geolokalisering till dina bilder. Aktivera bara integrationen och använd sedan snabbmenyn i filvyn för att fylla i eller skriva över saknade platser för markerade filer och mappar.",
                "IT": "Se registri le tue escursioni in Garmin Connect, puoi usare i dati del percorso per aggiungere automaticamente la geolocalizzazione alle tue foto. Attiva semplicemente l’integrazione e poi utilizza il menu contestuale nel file browser per compilare o sovrascrivere le località mancanti per i file e le cartelle selezionati."
            },

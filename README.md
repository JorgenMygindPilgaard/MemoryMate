...
Go to [https://github.com/JorgenMygindPilgaard/MemoryMate/releases/latest](https://github.com/JorgenMygindPilgaard/MemoryMate/releases/latest) and follow the instructions
### Get Source-code

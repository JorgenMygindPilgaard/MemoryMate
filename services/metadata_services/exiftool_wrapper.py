...
class ExifTool(object):
    ...
    def execute(self, args,process_id):
        ...
        process = ExifTool.getProcess(process_id)
        process_mutex = ExifTool.process_mutexes.get(process_id)

        with QMutexLocker(process_mutex):  # Wait for process to be ready
...
#        args.append('-n')
    ...
    def setTags(self, filenames, tag_values={},process_id='WRITE'):
        ...
        tag_values['XMP:MemoryMateSaveVersion']= Settings.get('version')
        args = []
